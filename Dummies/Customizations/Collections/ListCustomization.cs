...
{
    protected override IEnumerable<Type> Types { get; } = [typeof(List<>), typeof(IList<>), typeof(IEnumerable<>), typeof(IReadOnlyList<>), typeof(IReadOnlyCollection<>), typeof(ICollection<>)];
